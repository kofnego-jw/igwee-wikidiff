...
public interface XPathService {
	 ...
	 */
	List<String> evaluateAsStringList(InputStream xmlIn, String xpath,
	 ...
	 * @throws XsltException
	 */
	List<String> evaluateAsStringList(String uri, String xpath,
	 ...
	 * @throws XsltException
	 */
	List<String> evaluateFromCacheAsStringList(String cacheName, String xpath,
			Map<String,String> nsDecl) throws XsltException;
	 ...
	 */
	String bound(InputStream xml) throws XsltException;
	 ...
	 */
	String bound(String xmlUri) throws XsltException;
